...
class Admin extends Blog
{
    ...
    public function edit()
    {
      ...
      $this->oUtil->oAnimals = $this->oModel->getAllAnimals();
    ...
    public function editPost()
    {
      ...
      if (isset($_POST['edit_submit']))
      {
        ...
        else
        {
          ...
          $this->oModel = new \Clinique\Model\Admin;

          $aData = array('post_id' => $_GET['id'], 'nom' => $_POST['nom'], 'DateNaissance' => $_POST['DateNaissance']);
    ...
    public function add() //récupère les infos avec les superglobales $_POST et $_SESSION (['is_user_id']) et les stock dans un tableau
    {
      ...
      if (isset($_POST['add_submit']))
      {
          ...
          else
          {
            ...
            $aData = array('nom' => $_POST['nom'], 'DateNaissance' => $_POST['DateNaissance'],'id' => $_SESSION['is_user_id']); // stock les données dans un tableau + l'id de propriétaire -> Model/Admin.php add()
            ...
            $this->oUtil->sSuccMsg = 'L\'animal a bien été ajouté !';
          }
      }
      $this->oUtil->getView('add_animal');
    }

    // public function rqt($pseudo) {
    //   $this->oUtil->getModel('Admin');
    //   $this->oModel = new \Clinique\Model\Admin;
    //   return $this->oModel->getIdByPseudo($pseudo);
    // }
    ...
    // {
    //   // $this->oUtil->oAnimals = $this->oModel->getAnimals($_SESSION['is_user_id']);
    // }
