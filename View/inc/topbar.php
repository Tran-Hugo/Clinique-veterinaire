	...
	<nav class="blue lighten-2">
		<div class="container">
			<div class="nav-wrapper">
				...
				<!-- <img class="logo" src="<?=ROOT_URL?>/static/img/Vétérinaire.png"> -->

				<a href="<?=ROOT_URL?>blog_index.html" class="brand-logo">Clinique vétérinaire</a>
				...
				<ul class="right hide-on-med-and-down">
					...
					<li class="<?php echo ($_GET['a']=="chapters")?"active" : ""; ?>"><a href="<?=ROOT_URL?>blog_chapters.html">Planning</a></li>
					...
					<li><a href="<?=ROOT_URL?>admin_add.html" class="btn green">Ajouter un animal</a></li>
					<?php endif ?>
