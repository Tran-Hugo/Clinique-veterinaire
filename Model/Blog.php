...
class Blog
{
  ...
  {
    $this->oDb = new \Clinique\Engine\Db;
  }
  ...
  // public function getAnimalId($iId)
  // {
  ...
  public function getAnimals($uId) //  pour récupérer les infos dans la base de donnée et les stocker dans un tableau 
  { 
    ...
    ");
    $oStmt->bindParam(':userId', $uId, \PDO::PARAM_INT); // $uId étant la superglobale $_SESSION['is_user_id'] -> go to controller/blog.php ->index()
    $oStmt->execute();
